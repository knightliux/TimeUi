...
public class MainActivity extends FragmentActivity{
	...
	private void initViews() {
		...
		mNavigationItem=new NavigationItem(0,R.string.index,mInflater.inflate(R.layout.view_page_index, null),R.drawable.menu_1,R.drawable.menu_1_focus);
		
		mListViews.add(mNavigationItem);
		mListViews.add(new NavigationItem(1,R.string.apps,mInflater.inflate(R.layout.view_page_apps, null),R.drawable.menu_2,R.drawable.menu_2_focus));
		mListViews.add(new NavigationItem(2,R.string.app_manager,mInflater.inflate(R.layout.view_page_app_admin, null),R.drawable.menu_3,R.drawable.menu_3_focus));
...
//	            图文混排效果
					...
					SpannableString mSpannableString_up = new SpannableString("up");
					Bitmap mBitmap_up = BitmapFactory.decodeResource(getResources(), item.getImgRes()); 
					mBitmap_up=Bitmap.createScaledBitmap(mBitmap_up, 170, 170, false);
					ImageSpan mImageSpan_up = new ImageSpan(mBitmap_up, DynamicDrawableSpan.ALIGN_BOTTOM);
					mSpannableString_up.setSpan(mImageSpan_up, 0, 2, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
					btn.append(mSpannableString_up);   
...
//			if(item.getId()==0){
//			
//				PageIndexView pv=(PageIndexView) v.findViewById(R.id.pageindexview);
//				pv.UpView();
//			}
			v.invalidate();
		}catch(Exception e){
